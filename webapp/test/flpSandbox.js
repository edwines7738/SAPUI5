		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#eaesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eaesinvoices-display": {
								"semanticObject": "eaesinvoices",
								"action": "display",
								"description": "Mi primer Fiori de Facturas",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=eaes.invoices",
									"url": sap.ui.require.toUrl("eaes/invoices")
								}
							}
						}
					}
